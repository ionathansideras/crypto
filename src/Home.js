        ...
        <div className="div2">
          ...
          {colors.background === "white" ? (
            <img
              ...
              className="theme"
              onClick={changeTheme}
              src="https://img.icons8.com/ios-glyphs/30/null/sun--v1.png"
            />
          ) : (
            <img
              alt="sun"
      ...
      <div className="act">
        ...
        {colors.background == "white" ? (
          <img
            ...
            className="goUp"
            onClick={moveUp}
            src="https://img.icons8.com/ios/100/null/circled-chevron-up.png"
          />
        ) : (
          <img
            alt="uppage"
